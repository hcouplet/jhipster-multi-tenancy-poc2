...
import eu.creativeone.poc.domain.Author;
import eu.creativeone.poc.repository.AuthorRepository;
import eu.creativeone.poc.web.rest.errors.ExceptionTranslator;
...
public class AuthorResourceIntTest {
    ...
    private static final Integer DEFAULT_MY_SIZE = 1;
    private static final Integer UPDATED_MY_SIZE = 2;
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author()
            .name(DEFAULT_NAME)
            .mySize(DEFAULT_MY_SIZE)
            .nextVal(DEFAULT_NEXT_VAL);
        return author;
    }
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.isNextVal()).isEqualTo(DEFAULT_NEXT_VAL);
    }
    ...
    @Test
    @Transactional
    public void checkMySizeIsRequired() throws Exception {
        int databaseSizeBeforeTest = authorRepository.findAll().size();
        // set the field null
        author.setMySize(null);
    ...
    public void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].mySize").value(hasItem(DEFAULT_MY_SIZE)))
            .andExpect(jsonPath("$.[*].nextVal").value(hasItem(DEFAULT_NEXT_VAL.booleanValue())));
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        updatedAuthor
            .name(UPDATED_NAME)
            .mySize(UPDATED_MY_SIZE)
            .nextVal(UPDATED_NEXT_VAL);
        ...
        assertThat(testAuthor.isNextVal()).isEqualTo(UPDATED_NEXT_VAL);
    }
